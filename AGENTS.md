...
- Semantic UGC duration recovery must prefer complete source sentences, reject internal excerpt/source-review language at the persistence boundary, and fail closed after the bounded audience-safe rewrite attempts instead of saving contract-shaped but incoherent spoken copy.
