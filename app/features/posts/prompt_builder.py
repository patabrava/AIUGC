...
LEAN_LIGHT_BASE_PROMPT_TEMPLATE = (
    ...
    "Use the submitted canonical scene reference image as the environment, layout, prop, and lighting source. "
    "Preserve the same face, facial proportions, skin texture, hair identity, and age from the actor references while "
