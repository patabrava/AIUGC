...
def _build_prompt_writer_brief(
    *,
    ...
    return (
        ...
        "Use an arm's-length selfie crop: the top edge sits just above her hair and the bottom edge cuts across her "
        "chest below the armpits, so her head alone fills about 40 to 45 percent of the frame height and her face "
...
def _build_composition_prompt(*, prompt_writer_output: str) -> str:
    return (
        ...
        "location visible past her shoulder, no motion blur, and no beauty polish. "
