...
def _build_prompt_writer_brief(
    *,
    ...
    return (
        ...
        "Use an arm's-length selfie crop from just above the top of her head to her upper chest, so her face fills "
        "roughly 40 to 45 percent of the frame height and stays identity-readable while the supplied room remains "
        "recognizable behind her. The phone sits slightly above her eye line and angles down a few degrees, the "
        "horizon rolls a few degrees off level, and she sits noticeably off-center. "
...
def _build_composition_prompt(*, prompt_writer_output: str) -> str:
    return (
        ...
        "just above the head to the upper chest, face and hands anatomically plausible, enough background visible to lock "
        "the location, no motion blur, and no beauty polish. "
