...
def test_production_deploy_pins_resumable_flash_scene_plate_traffic_contract():
    ...
    assert '"SEMANTIC_SCENE_PLATE_BUNDLE_ENABLED": "false"' in workflow
    ...
    assert '"SEMANTIC_SCENE_IMAGE_WORKER_CONCURRENCY": "2"' in workflow
    assert '"SEMANTIC_SCENE_PLATE_MAX_CONCURRENCY": "2"' in workflow
    assert '"SEMANTIC_SCENE_PLATE_START_INTERVAL_SECONDS": "1"' in workflow
