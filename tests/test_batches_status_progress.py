...
def test_build_batch_detail_view_defaults_new_batch_to_fast_veo_model():
    ...
    assert view["video_generation_settings"]["initial_model"] == "veo-3.1-fast-generate-001"
...
def test_build_batch_detail_view_forces_semantic_ugc_to_full_veo_model(monkeypatch):
    monkeypatch.setattr(
        batch_handlers.semantic_video_queries,
        "get_run_by_post",
        ...
        "posts": [
            {
                ...
                "video_url": None,
                "video_status": None,
                "video_prompt_json": {"veo_prompt": "Legacy prompt"},
                "video_metadata": {
                    "requested_model": "veo-3.1-lite-generate-001",
                    "provider_model": "veo-3.1-lite-generate-001",
                },
        ...
        "posts": [
            {
                "id": "post-1",
                "post_type": "value",
                "topic_title": "Ready to submit",
                "video_url": None,
                "video_status": "pending",
                "video_prompt_json": {"hello": "world"},
                "seed_data": {
                    "script_review_status": "approved",
                },
            },
