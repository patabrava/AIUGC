...
from app.features.publish.schemas import TikTokUploadDraftRequest
...
def test_upload_tiktok_draft_persists_job_and_post_result(monkeypatch):
    ...
    assert storage["posts"][0]["publish_results"]["tiktok"]["status"] == "draft_uploaded"
    assert storage["posts"][0]["platform_ids"]["tiktok"] == "publish-1"
